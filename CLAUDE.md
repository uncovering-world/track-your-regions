...
- **experience_kinds** — what a traveller browses by: World Heritage Sites (id=1), Art Museums (id=2), Public Art & Monuments (id=3), Places of worship (id=4), under the ids of the sources that fill them
...
- **experience_categories** — the *sources*: UNESCO (id=1), Art Museums (id=2), Public Art & Monuments (id=3), Places of worship (id=4, Wikidata, gated on arrival, ADR-0052), each naming the kind it fills (`kind_id`). `display_priority` controls ordering (lower = first). Every reader still keys on it through `experiences.category_id` until #819
