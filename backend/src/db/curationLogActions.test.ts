 ...
 *
 * `@tyr/shared/curationLog` and `@tyr/shared/auth` declare, once for both
 * sides, what an `experience_curation_log.action` may be and what a user's
 * role and sign-in provider may be. The schema is the third statement of each:
