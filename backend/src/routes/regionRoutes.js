...
router.get(
   ...
   * @returns {Array<Object> | Array} An array of root regions or an empty array
   * in the response.
   */
  ...[
...
router.get(
   ...
   * @returns {Array<Object> | Array} An array of ancestor regions or an empty array
   * in response if no ancestors are found.
   */
  ...[
    check('regionId').isInt().withMessage('Region ID must be an integer'),
  ],
...
router.get(
   ...
   * @returns {Object | Array} The geometry data or an empty object
   * in response if 'resolveEmpty' is true.
   */
  ...[
    check('regionId').isInt().withMessage('Region ID must be an integer'),
